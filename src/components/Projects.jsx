  ...
  return (
    <div className="section-container">
      ...
      <div className="container-content">
        ...
        <div className="project-section-wrapper">
          <img
            ...
            src="public/project-roam-1080.jpg"
        ...
        <img
          className="project-image"
          src="public/project-mozilla.jpg"
          alt="screenshot of roam homepage"
        />
        <div className="project-section">
          <h3>
      ...
      <div className="project-section-wrapper">
        <img
          className="project-image"
          src="public/project-readme-1080.jpg"
        ...
        <div className="project-section">
          ...
          <p>
            A full-stack MERN web application for finding and tracking your next
            book.
          </p>
          <ul className="stack-bubbles-container">
      ...
      <div className="project-section-wrapper">
        <img
          className="project-image"
          src="public/project-plantpet-1080.jpg"
